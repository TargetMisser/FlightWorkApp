...
function ContactRowComponent({ contact, onEdit, onDelete }: ContactRowProps) {
  ...
  return (
    <View style={rowStyles.card}>
      ...
      <TouchableOpacity style={[rowStyles.callBtn, { backgroundColor: color }]} onPress={call} accessible={true} accessibilityRole="button" accessibilityLabel={t("phonebookCall")}>
        <MaterialIcons name="call" size={18} color="#fff" />
      </TouchableOpacity>
      <TouchableOpacity style={rowStyles.editBtn} onPress={() => onEdit(contact)} accessible={true} accessibilityRole="button" accessibilityLabel={t("phonebookEdit")}>
        <MaterialIcons name="edit" size={18} color={colors.textSub} />
      </TouchableOpacity>
      <TouchableOpacity style={rowStyles.editBtn} onPress={confirmDelete} accessible={true} accessibilityRole="button" accessibilityLabel={t("phonebookDelete")}>
