...
function ContactRowComponent({ contact, onEdit, onDelete }: ContactRowProps) {
  ...
  return (
    <View style={rowStyles.card}>
      ...
      <TouchableOpacity
        style={[rowStyles.callBtn, { backgroundColor: color }]}
        onPress={call}
        accessible={true}
        accessibilityRole="button"
        accessibilityLabel={t('contactCallA11y')}
      >
      ...
      <TouchableOpacity
        ...
        accessible={true}
        accessibilityRole="button"
        accessibilityLabel={t('contactEditA11y')}
      >
      ...
      <TouchableOpacity
        ...
        accessible={true}
        accessibilityRole="button"
        accessibilityLabel={t('contactDeleteConfirm')}
      >
