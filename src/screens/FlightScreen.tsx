...
function FlightRowComponent({ item, activeTab, userShift, pinnedFlightId, onPin, onUnpin, inboundArrivals, colors, s, smPool, locale, t }: FlightRowProps) {
  ...
  const accessibilityLabel = useMemo(() => {
    ...
    parts.push(`${flightNumber}, ${airline}`);
    parts.push(activeTab === 'arrivals' ? t('flightFrom') : t('flightTo'));
    parts.push(originDest);
    parts.push(time);
  ...
  return (
    ...
    >
      <TouchableOpacity
        ...
        accessibilityLabel={`${flightNumber} — ${t('flightOpenExternal')}`}
