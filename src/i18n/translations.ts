...
const it = {
  ...
  flightAccessibilityPin: 'Fissa volo',
  flightAccessibilityUnpin: 'Rimuovi dai fissati',
  flightAccessibilityPinHint: 'Aggiunge il volo alla sezione in evidenza e attiva le notifiche dedicate.',
  flightAccessibilityUnpinHint: 'Rimuove il volo dalla sezione in evidenza.',
  flightFrom: 'da',
  flightTo: 'per',
