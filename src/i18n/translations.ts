...
const it = {
  ...
  flightOpenExternal: 'Apre i dettagli del volo su Flightradar24',
  flightAccessibilityPin: 'Pinna volo', flightAccessibilityUnpin: 'Rimuovi pin',
  flightAccessibilityPinHint: 'Aggiunge il volo alla sezione in alto e attiva le notifiche dedicate',
  flightAccessibilityUnpinHint: 'Rimuove il volo dalla sezione in alto',
...
const en: typeof it = {
  ...
  flightOpenExternal: 'Opens flight details on Flightradar24',
  flightAccessibilityPin: 'Pin flight', flightAccessibilityUnpin: 'Unpin flight',
  flightAccessibilityPinHint: 'Adds the flight to the top section and enables dedicated notifications',
  flightAccessibilityUnpinHint: 'Removes the flight from the top section',
