...
const it = {
  ...
  flightProviderSettingsTitle: 'Provider voli',
  flightProviderSettingsSub: 'Scegli la fonte preferita e salva le API key solo sul dispositivo.',
...
const en: typeof it = {
  ...
  flightProviderSettingsTitle: 'Flight providers',
  flightProviderSettingsSub: 'Choose the preferred source and keep API keys only on this device.',
